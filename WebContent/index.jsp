...
<body>
	...
	<div id="header">
		<div id="nav-wrapper">
			...
			<nav id="nav">
				<ul>
					<li><a href="/CereaisSulWeb/login">Login</a></li>
		...
		<div class="container">
			...
			<div id="logo">
				<h1>
					<a href="#">Cereais Sul,</a>
				</h1>
				<span class="tag">seu parceiro na compra e
						venda de Grãos !</span>
			</div>
		</div>
	</div>
...
<!-- 			<section> -->
<!-- 				<header> -->
<!-- 					<h2>Bem vindo ao Sistema Comercial da Cereais Sul !</h2> -->
<!-- 					<span class="byline">Cereais Sul, seu parceiro na compra e -->
<!-- 						venda de Grãos !</span> -->
<!-- 				</header> -->
<!-- 			</section> -->
<!-- 		</div> -->
			...
			<section>
				<header>
					...
					<span class="byline">Avenida Circular n° 209 ,<br>
						...
						Rural - Buritis - MG <br> Telefone: (61) 3642-2600
					</span>
				</header>
<!-- 				<ul class="contact"> -->
