...
<!-- 					<li><a href="/CereaisSulWeb/relatorios">Relatórios</a></li> -->
	...
	<div id="main">
		<div id="content" class="container">
			<section>
				<header>
				<a href="/CereaisSulWeb/listaContratosDeCompra">Relatório de Contratos de Compra</a> <br><a href="/CereaisSulWeb/listaContratosDeVenda">Relatório de Contratos de Venda</a>
		...
		<div class="container">
			<section>
				<header>
					...
					<span class="byline"> Unidade 1: Avenida Circular n° 209 ,<br>
						Formosinha, Formosa - GO CEP: 73.813-170 Telefone: (61) 3642-2600<br><br>Unidade 2:
